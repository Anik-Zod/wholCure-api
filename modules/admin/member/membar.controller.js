...
export async function createMember(req, res) {
    try {
        ...
        // Upload from buffer (memory storage) using upload_stream
...
export async function updateMember(req, res) {
    const { id } = req.params;
    const { name, email, phone, address, socialMedia, description, role } = req.body;

    try {
        const updateData = { name, email, phone, address, socialMedia, description, role };
